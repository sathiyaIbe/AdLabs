...
//     };
  ...
  const tl=gsap.timeline({
    scrollTrigger:{
      ...
      duration:5,
      markers:true,
      pin:'.scroll-section-inner',
    
      scrub:1,
    }
  })
  tl.to(".scroll-section-inner",{xPercent:-20,duration:5})
  .to(".scroll-section-inner",{xPercent:-20,duration:5})
  .to(".scroll-section-inner",{xPercent:-20,duration:5})
  .to(".scroll-section-inner",{xPercent:-20,duration:5})
  .to(".scroll-section-inner",{xPercent:-20,duration:5})
...
function rotateFunction(e){
  ...
  return(
    <section id='Service' className="scroll-section-outer  overflow-hidden  min-h-[110vh] ">
      ...
      <div ref={triggerRef}>
        ...
        {/* <div className="scroll-section">
          ...
          <div ref={sectionRef}  className="scroll-section marker1  flex flex-col mt-11">
          ...
          <div className="scroll-section  flex flex-col mt-11">
            <div className="self-center w-[60%] flex">
            <div className="flex flex-col gap-3 pr-6">
